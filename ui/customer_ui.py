...
class CustomerUI:
    ...
    def __topbar(self) -> None:
        ...
        self.__search_customers_entry = customtkinter.CTkEntry(master=topbar_frame,
                                                               ...
                                                               font=("arial", 17),
                                                               border_width=1)
        self.__search_customers_entry.place(x=174, y=8)

        self.__search_customers_button = customtkinter.CTkButton(master=topbar_frame,
                                                                 width=230, height=32,
                                                                 corner_radius=4,
                                                                 text_color=WHITE_COLOR,
                                                                 font=("arial", 15), 
    ...
    def __customer_ui(self) -> None:
        ...
        self.__customer_treeview = ttk.Treeview(master=self.__square_frame,
                                                height=28,
        ...
        del_customer_button = customtkinter.CTkButton(master=self.__square_frame,
                                                      width=230, height=32,
                                                      text_color=WHITE_COLOR,
                                                      fg_color=RED_COLOR,
        ...
        update_customer_button = customtkinter.CTkButton(master=self.__square_frame,
                                                         width=230, height=32,
                                                         text_color=WHITE_COLOR,
                                                         ...
                                                         command=self.__update_customer_ui)
        update_customer_button.place(x=1165, y=868)

        create_customer_button = customtkinter.CTkButton(master=self.__square_frame,
                                                         width=230, height=32,
                                                         text_color=WHITE_COLOR,
    ...
    def __create_customer_ui(self) -> None:
        ...
        self.__topbar_label.configure(text="Add Customer")
        self.__search_customers_entry.destroy()
        self.__search_customers_button.destroy()

        add_customer_frame = customtkinter.CTkFrame(master=self.__square_frame,
        ...
        add_customer_button = customtkinter.CTkButton(master=self.__square_frame,
                                                      width=230, height=32,
                                                      text_color=WHITE_COLOR,
                                                      fg_color=GREEN_COLOR,
                                                      hover_color=GREEN_HOVER_COLOR,
    ...
    def __update_customer_ui(self) -> None:
        ...
        self.__topbar_label.configure(text="Update Customer")
        self.__search_customers_entry.destroy()
        self.__search_customers_button.destroy()

        update_customer_frame = customtkinter.CTkFrame(master=self.__square_frame,
